...
const ICON_MAP: Record<string, string> = {
  ...
  jewelry: "💍", accessories: "👜", default: "✨",
};

const DEFAULT_CATEGORIES = [
  { id: "1", name: "Fashion",      slug: "fashion",      icon: "fashion",      isActive: true },
  { id: "2", name: "Electronics",  slug: "electronics",  icon: "electronics",  isActive: true },
  { id: "3", name: "Beauty",       slug: "beauty",       icon: "beauty",       isActive: true },
  { id: "4", name: "Home & Living",slug: "home",         icon: "home",         isActive: true },
  { id: "5", name: "Sports",       slug: "sports",       icon: "sports",       isActive: true },
  { id: "6", name: "Accessories",  slug: "accessories",  icon: "accessories",  isActive: true },
];
